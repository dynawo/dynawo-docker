...
usage() {
  ...
  where OPTIONS can be one of the following:
    --container-name (-n) mycontainer   container name created (default: dynawo-distribution-cxx11)
    --image-name (-i) myimage           image name (default: dynawo-distribution-cxx11)
